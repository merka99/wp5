...
if ( ! function_exists( 'durga_get_defaults' ) ) {
	/**
	 * Set default options
	 *
	 */
	function durga_get_defaults() {
		$durga_defaults = array(
			'hide_title' => '',
			'hide_tagline' => true,
			'top_bar_width' => 'full',
		...
		return apply_filters( 'durga_option_defaults', $durga_defaults );
	}
}

if ( ! function_exists( 'durga_get_color_defaults' ) ) {
	/**
	 * Set default options
	 */
	function durga_get_color_defaults() {
		$durga_color_defaults = array(
			...
			'blog_header_button_hover_bg' => '#222222',
		...
		return apply_filters( 'durga_color_option_defaults', $durga_color_defaults );
	}
}
...
if ( ! function_exists( 'durga_get_default_fonts' ) ) {
	 ...
	 */
	function durga_get_default_fonts( $filter = true ) {
		$durga_font_defaults = array(
			'font_body' => 'Yanone Kaffeesatz',
			'font_body_category' => '',
			'font_body_variants' => '200,300,regular,700',
			...
			'font_site_title' => 'Sorts Mill Goudy',
			'font_site_title_category' => '',
			'font_site_title_variants' => 'regular,italic',
			...
			'font_blog_header_title' => 'Sorts Mill Goudy',
			'font_blog_header_title_category' => '',
			'font_blog_header_title_variants' => 'regular,italic',
			...
			'font_buttons' => 'Sorts Mill Goudy',
			'font_buttons_category' => '',
			'font_buttons_variants' => 'regular,italic',
		...
		if ( $filter ) {
			return apply_filters( 'durga_font_option_defaults', $durga_font_defaults );
		}

		return $durga_font_defaults;
	}
}

if ( ! function_exists( 'durga_spacing_get_defaults' ) ) {
	/**
	 ...
	 * @return array Option defaults.
	 */
	function durga_spacing_get_defaults( $filter = true ) {
		$durga_spacing_defaults = array(
			'top_bar_top' => '6',
			'top_bar_right' => '20',
			'top_bar_bottom' => '3',
			'top_bar_left' => '20',
		...
		if ( $filter ) {
			return apply_filters( 'durga_spacing_option_defaults', $durga_spacing_defaults );
		}

		return $durga_spacing_defaults;
	}
}

if ( ! function_exists( 'durga_get_default_color_palettes' ) ) {
	/**
	 * Set up our colors for the color picker palettes and filter them so you can change them.
	 *
	 */
	function durga_get_default_color_palettes() {
		$palettes = array(
			'#222222',
			'#333333',
			'#555555',
		...
		return apply_filters( 'durga_default_color_palettes', $palettes );
	}
}

if ( ! function_exists( 'durga_typography_default_fonts' ) ) {
	/**
	 * Set the default system fonts.
	 *
	 */
	function durga_typography_default_fonts() {
		$fonts = array(
			'inherit',
			'System Stack',
		...
		return apply_filters( 'durga_typography_default_fonts', $fonts );
	}
}

define( 'DURGA_DEFAULT_FONTS' , '//fonts.googleapis.com/css?family=Yanone+Kaffeesatz:200,300,regular,700|Sorts+Mill+Goudy:regular,italic' );
