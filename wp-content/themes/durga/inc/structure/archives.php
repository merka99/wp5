...
if ( ! function_exists( 'durga_archive_title' ) ) {
	add_action( 'durga_archive_title', 'durga_archive_title' );
	/**
	 * Build the archive title
	 *
	 */
	function durga_archive_title() { ?>
		<header class="page-header<?php if ( is_author() ) echo ' clearfix';?>">
			<?php
			/**
			 * durga_before_archive_title hook.
			 *
			 */
			do_action( 'durga_before_archive_title' );
			?>
			...
			<?php
			/**
			 * durga_after_archive_title hook.
			 *
			 */
			do_action( 'durga_after_archive_title' );
			...
			/**
			 * durga_after_archive_description hook.
			 *
			 */
			do_action( 'durga_after_archive_description' ); ?>
		</header><!-- .page-header -->
		<?php
	}
}

if ( ! function_exists( 'durga_filter_the_archive_title' ) ) {
	add_filter( 'get_the_archive_title', 'durga_filter_the_archive_title' );
	/**
	 ...
	 */
	function durga_filter_the_archive_title( $title ) {
		if ( is_category() ) {
